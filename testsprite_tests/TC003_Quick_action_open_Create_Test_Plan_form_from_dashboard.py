...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and click the 'Giriş Yap' button to authenticate (perform inputs on indexes 9 and 10, then click index 15).
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Create Test Plan').first).to_be_visible(timeout=3000)

...
async def run_test():
    ...
    try:
        ...
        # -> Type the provided email into the email field, type the provided password into the password field, then click the 'Giriş Yap' (Login) button to authenticate.
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Test Mekan TR - Salon A').first).to_be_visible(timeout=3000)

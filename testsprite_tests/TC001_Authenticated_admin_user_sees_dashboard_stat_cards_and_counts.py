...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and click the 'Giriş Yap' button to authenticate.
        ...
        await expect(frame.locator('text=Arsiv Eserleri').first).to_be_visible(timeout=3000)
        await expect(frame.locator('text=Etkinlikler').first).to_be_visible(timeout=3000)
        await expect(frame.locator('text=Test Planlari').first).to_be_visible(timeout=3000)

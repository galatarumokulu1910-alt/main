                ...
                <div className="footer__grid">
                    ...
                    <div className="footer__col">
                        ...
                        <div className="footer__socials">
                            ...
                            {/* X / Twitter (The camera-like svg is Instagram, so the 'X' must be the middle one or vice versa... Wait, checking the path. The middle one is the bird/X logo. The last one with the circle in the middle is the camera (Instagram).) */}

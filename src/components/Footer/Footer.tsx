            ...
            <div className="footer__inner">
                <div className="footer__grid">
                    ...
                    <div className="footer__col footer__col--newsletter">
                        ...
                        <p className="footer__newsletter-desc">Etkinliklerimizden haberdar olmak icin bultene abone olun:</p>
                        <form className="footer__newsletter-form" onSubmit={(e) => { e.preventDefault(); alert("Newsletter signed up!"); }}>
                            <input type="email" placeholder="E-posta adresiniz" className="footer__input" required />
                            <button type="submit" className="footer__submit">Abone Ol</button>
                        </form>
                    </div>

                    {/* Column 2: Hours & Sponsor */}
                    <div className="footer__col">
                        <h4 className="footer__heading">Ziyaret Saatleri</h4>
                        <p className="footer__text">
                            Pazartesi haric her gun<br />
                            <span className="footer__bold-text">10:00 – 18:00</span>
                        </p>
                        <div className="footer__sponsor">
                            <h4 className="footer__heading footer__heading--primary">Destekcimiz</h4>
                            <p className="footer__sponsor-name">AMMF Foundation</p>
                        </div>
                    </div>

                    {/* Column 3: Contact & Socials */}
                    <div className="footer__col">
                        <h4 className="footer__heading">Iletisim</h4>
                ...
                <div className="footer__bottom">
                    <p>Galata Rum Okulu &copy; 2026. Tum haklari saklidir.</p>
                    <div className="footer__legal-links">
                        <a href="#" className="footer__legal-link">KVKK</a>
                        <a href="#" className="footer__legal-link">Gizlilik Politikasi</a>
                        <a href="#" className="footer__legal-link">Cerez Politikası</a>
                    </div>
                </div>
            </div>
        </footer>
